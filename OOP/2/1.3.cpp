...
int main()
{
	...
	while (true)
	{
		...
		case 1:
		{
			...
			ofstream out("AllStudents.bin", ios::binary | ios::app);
		...
		case 2:
		{
			ifstream infile("AllStudents.bin", ios::binary);
		...
		case 3:
		{
			...
			ifstream infile("AllStudents.bin", ios::binary);
			ofstream out("OldestStudents.bin", ios::binary | ios::app);
		...
		case 4:
		{
			ifstream infile("OldestStudents.bin", ios::binary);
